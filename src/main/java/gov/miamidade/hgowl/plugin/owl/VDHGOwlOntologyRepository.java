...
/**
 * VDHGOwlOntologyRepository is a protege repository implementation backed by a
 * Hypergraph Ontology Repository instance. This enabled Protege to show
 * Hypergraph ontologies at startup.
 * 
...
public class VDHGOwlOntologyRepository implements OntologyRepository
{
	...
	public static final List<Object> METADATA_KEYS_EXT = Arrays.asList(new Object[] { VERSION_URI, PHYSICAL_URI, HEAD_REVISION,
			DISTRIBUTED_INFO });
