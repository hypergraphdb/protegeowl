...
public class RepositoryViewPanel extends JPanel {
    ...
    public static OntologyRepositoryEntry showOpenDialog(OntologyRepository repository) {
        ...
        int ret = JOptionPaneEx.showConfirmDialog(null, "Open Ontology from " + repository.getName(), panel, JOptionPane.PLAIN_MESSAGE, JOptionPane.OK_CANCEL_OPTION, panel.table);
