...
public class HGOwlProperties
{
	...
	/**
	 * @param hgLocationFolderPath
	 *            the hgLocationFolderPath to set
	 */
	...
	/**
	 * @param showLegacyEditorKit
	 *            the showLegacyEditorKit to set
	 */
	...
	/**
	 * @param p2pHostName
	 *            the setP2pServer hostname to set
	 */
	...
	/**
	 * @param p2pAskForRemote
	 *            the p2pAskForRemote to set
	 */
